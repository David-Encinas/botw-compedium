  ...
  <div className="right-col">
    ...
    <div className="info">       
      ...
      <div>
        ...
        {hearts_recovered ? <p><b>Hearts Recovery:</b> <span>{hearts_recovered}</span></p> : ''}
      </div> 

      {common_locations && common_locations.length > 0 ? <div className="info-list common_locations">
      ...
      {drops && drops.length > 0 ? <div className="info-list drops_locations">
        <h4>Drops: </h4>
        <ul>
      ...
      {cooking_effect ? <div className="info-list cooking_effect">
        <h4>Cooking Effect: </h4>
        <ul>
          <li>{cooking_effect}</li>
        </ul> 
      </div> : ''}
